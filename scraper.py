...
quote_page = 'https://www.allrecipes.com/recipe/255864/berbere-spiced-chicken-breasts/?internalSource=previously%20viewed&referringContentType=home%20page'
page = urllib2.urlopen(quote_page)
soup = BeautifulSoup(page, 'html.parser')

name_box = soup.find('h1', attrs={'class': 'recipe-summary__h1'})
